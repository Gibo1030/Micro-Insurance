...
class InsuranceModelTest(TestCase):
    ...
    def test_creating_a_new_insurance_saving_to_the_database(self):
        ...
        insurance.insurance_validity_start = datetime.date.today()
        insurance.insurance_validity_end = datetime.date.today()
        ...
        self.assertEquals(only_insurance_in_database.insurance_validity_start, insurance.insurance_validity_start)
        self.assertEquals(only_insurance_in_database.insurance_validity_end, insurance.insurance_validity_end)
